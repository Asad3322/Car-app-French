const en = {
  ...
  incidentDetails: {
    ...
    reportedCarEvidence: "Reported car evidence",
    urgent: "Urgent",
    medium: "Medium",
    ...
    unregisteredVehicle: "Unregistered Vehicle",
    dateTime: "Date & Time",
    notAvailable: "N/A",
    incidentDescription: "Incident Description",
    assistantTip: "Assistant Tip",
    assistantMessage:
      "This report was verified by our community. Review the details carefully and stay aware of similar incidents nearby.",
    quickFeedback: "Quick Feedback",
    sayThanks: "Say Thanks",
    badReport: "Bad Report",
    communityVerifiedReport: "Community Verified Report",
    thanksSent: "Thanks sent to the reporter",
    reportFlagged: "Report flagged for review",
  },
  leaderboard: {
    title: "Leaderboard",
    ...
    coins: "Coins",
    streak: "Streak",
    weekLeaderboard: "Week Leaderboard",
    global: "Global",
    reports: "Reports",
    pts: "pts",
    coinsLower: "coins",
