              ...
              <p className="mt-3 text-[14px] text-[#6F8194]">
                {!linkSent
                  ? isOwner
                    ...
                    : t("verify.reporterDescription")
                  : isOwner
                    ? t("verify.ownerVerified")
                    : t("verify.reporterVerified")}
              </p>
            </div>
            ...
            {!linkSent ? (
              <div>
                <label className="mb-2 block text-[11px] font-black uppercase text-[#6F8194]">
                  {isOwner ? t("auth.phoneNumber") : t("auth.emailAddress")}
                </label>
                ...
                <p className="mt-3 text-[13px] text-[#6F8194]">
                  {isOwner
                    ? t("verify.ownerSecureText")
                    : t("verify.reporterSecureText")}
                </p>
              ...
              <div className="text-center">
                ...
                <div className="mt-4">
                  ...
                  <p className="text-[14px] text-[#6F8194]">
                    {isOwner
                      ? t("verify.ownerNextStep")
                      : t("verify.reporterNextStep")}
                  </p>
                </div>
                ...
                >
                  {isOwner ? t("verify.changePhone") : t("verify.changeEmail")}
                </button>
              </div>
            )}
