      ...
      <div className="relative flex flex-1 flex-col">
          ...
          <div className="mt-10 w-full max-w-[320px]">
            <div className="rounded-[32px] border border-[#D9E5F1] bg-white px-6 py-7 shadow-sm">
              <div className="flex flex-col items-center">
                ...
                <p className="mt-4 rounded-full bg-[#EEF6FF] px-4 py-2 text-[11px] font-black text-[#4A90E2]">
                  {badge}
                </p>
              </div>
            </div>
        ...
        <div className="pb-8">
          <div className="mx-auto flex w-full max-w-[320px] flex-col gap-3">
            ...
            <Link
              to="/"
              className="flex h-12 items-center justify-center rounded-[18px] border"
            >
              {t("success.skip")}
            </Link>
          </div>
